window.addEventListener('DOMContentLoaded', function() {
  ...
  if(cookieOptin == 'no') {
    ...
    //Disable Google Analytics（UA-130951038-3 の部分は正しいものに書き換えてください）
    window['ga-disable-UA-130951038-3'] = true;

  //ga_cookie_opt_in = yes なら Google Analytics トラッキングコードを発行
  } else if(cookieOptin == 'yes') {
    console.log('ga_cookie_opt_in = yes');
    //Enable Google Analytics（UA-130951038-3 の部分は正しいものに書き換えてください）
    window['ga-disable-UA-130951038-3'] = false;
